...
export const BTC = require('./logo_bitcoin.png');
export const XAF = require('./logo_cfa_franc.png');
export const CUC = require('./logo_cuc.png');
export const XBB = require('./logo_emu.png');
export const XBA = require('./logo_eurco.png');
export const XAU = require('./logo_gold ounce.png');
export const SSP = require('./logo_golden-ssp.png');
export const AAD = require('./logo-arab-dinar.png');
export const IMP = require('./logo-manx-pound.png');
export const ECU = require('./logo_ecu.png');
export const GGP = require('./logo_guernsey pound.png');
export const XPD = require('./logo_palladium ounce.png');
export const PPP = require('./logo_percentage_of_par.png');
export const XPT = require('./logo_platinum_ounce.png');
export const STN = require('./logo_sao-tome-principe-flag.png');
export const XAG = require('./logo_silver_ounce.png');
export const XDR = require('./logo_special_drawing_rights.png');
export const XUA = require('./logo_unit_of_account.png');
export const YUM = require('./logo_yugoslav_dinar.png');
