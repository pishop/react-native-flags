...
export const BTC = require('./logo_bitcoin@3x.png');
export const XAF = require('./logo_cfa_franc@3x.png');
export const CUC = require('./logo_cuc@3x.png');
export const XBB = require('./logo_emu@3x.png');
export const XBA = require('./logo_eurco@3x.png');
export const XAU = require('./logo_gold ounce@3x.png');
export const SSP = require('./logo_golden-ssp@3x.png');
export const AAD = require('./logo-arab-dinar@3x.png');
export const IMP = require('./logo-manx-pound@3x.png');
export const ECU = require('./logo_ecu@3x.png');
export const GGP = require('./logo_guernsey pound@3x.png');
export const XPT = require('./logo_palladium ounce@3x.png');
export const PPP = require('./logo_percentage_of_par@3x.png');
export const XPT = require('./logo_platinum_ounce@3x.png');
export const STN = require('./logo_sao-tome-principe-flag@3x.png');
export const XAG = require('./logo_silver_ounce@3x.png');
export const XDR = require('./logo_special_drawing_rights@3x.png');
export const XUA = require('./logo_unit_of_account@3x.png');
export const YUM = require('./logo_yugoslav_dinar@3x.png');
